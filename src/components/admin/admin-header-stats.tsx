...
/**
 * Fila de estadísticas del panel admin — se muestra igual en las 4 pestañas
 * (Equipos y pagos, Partidos, Árbitros, Operadores), justo debajo del
 * título. Todos los valores salen de consultas reales, no son
 * placeholders: equipos validados sobre el cupo configurado en
 * `torneo_config`, recaudado sobre la meta de inscripciones (cupo × valor
 * de inscripción — todavía no hay una meta de patrocinio propia en el
 * sistema, ver brief original sección 6), partidos programados/finalizados
 * y árbitros activos.
 */
